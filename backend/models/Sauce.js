...
const sauceSchema = mongoose.Schema({
  ...
  usersLiked: { type:  [String] },                 //tableau des identifiants des utilisateur qui ont aimé (= liked) la sauce
  usersDisliked: { type: [String] },               //tableau des identifiants des utilisateur qui n'ont  pas aimé (= disliked) la sauce
});
